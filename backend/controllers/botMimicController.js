...
// Function to automatically progress application status for technical jobs
exports.runBotMimic = async () => {
  try {
    // Find Technical applications with eligible statuses
    ...
    for (const app of applications) {
      // Advance status: Applied -> Reviewed -> Interview -> Offer
      let newStatus = '';
      switch(app.status) {
        case 'Applied':
          newStatus = 'Reviewed';
