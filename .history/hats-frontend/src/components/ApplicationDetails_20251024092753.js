...
import StatusUpdateForm from './StatusUpdateForm';  // Import
...
const ApplicationDetails = () => {
  ...
  return (
    <div className="container mt-4" style={{ maxWidth: '700px' }}>
      ...
      {/* StatusUpdateForm for editing status and adding comment */}
      <StatusUpdateForm
        application={application}
        afterUpdate={fetchApplication}  // Refresh details after update
      />
