...
export default function ApplicationList() {
  ...
  return (
    <div className="container my-4">
      <h2 className="mb-4 fw-bold text-center">Applications</h2>
            ...
            <div key={app._id} className="col">
              <div className="card h-100 shadow-sm">
                <div className="card-body">
                  ...
                  <h6 className="card-subtitle mb-2 text-muted">{app.jobType} - Status: {app.status}</h6>
                  <p className="card-text"><strong>Applicant:</strong> {app.applicant?.name || 'N/A'} ({app.applicant?.email || 'N/A'})</p>
